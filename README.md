...
To achieve the goal, a [Waveshare 10.3 inch 16 gray scale color e-paper device][waveshare-10.3-inch-16-gray-scale-color-epaper-device] (SKU: 18434) and a [Raspberry Pi Zero 2 W][raspberry-pi-zero-2-w] with [Raspberry Pi OS][raspberry-pi-os] for operating system were chosen.
...
| --------------------- | ------------------------------------------------------------------- |
| __`Rec601Luma`__      | ![](docs/img/IMG0023_768x512_grayscale_Rec601Luma_16grays.png)      |
| __`Rec601Luminance`__ | ![](docs/img/IMG0023_768x512_grayscale_Rec601Luminance_16grays.png) |
| __`Rec709Luma`__      | ![](docs/img/IMG0023_768x512_grayscale_Rec709Luma_16grays.png)      |
| __`Rec709Luminance`__ | ![](docs/img/IMG0023_768x512_grayscale_Rec709Luminance_16grays.png) |
| __`Brightness`__      | ![](docs/img/IMG0023_768x512_grayscale_Brightness_16grays.png)      |
| __`Lightness`__       | ![](docs/img/IMG0023_768x512_grayscale_Lightness_16grays.png)       |
| __`Average`__         | ![](docs/img/IMG0023_768x512_grayscale_Average_16grays.png)         |
| __`RMS`__             | ![](docs/img/IMG0023_768x512_grayscale_RMS_16grays.png)             |

All the images above were generated using [ImageMagick](https://imagemagick.org/) with the following “one-liner”:

```bash
printf '%s\n' 'P2' '16 1' '255' '0' '17' '34' '51' '68' '85' '102' '119' '136' '153' '170' '187' '204' '221' '238' '255' > gray_palette.pgm && convert 'IMG0023.tif' -filter lanczos -resize 768x 'IMG0023_768x512.png' && for grayscale_method in 'Rec601Luma' 'Rec601Luminance' 'Rec709Luma' 'Rec709Luminance' 'Brightness' 'Lightness' 'Average' 'RMS' ; do convert 'IMG0023.tif' -filter lanczos -resize 768x -grayscale "${grayscale_method}" -dither FloydSteinberg -remap gray_palette.pgm "IMG0023_768x512_grayscale_${grayscale_method}_16grays.png" ; done
```
...
5. Disable internet connection (optional).
   ...
   See the following chained command to create a backup of your Raspberry Pi's `config.txt` file and to completely disable Bluetooth and Wi-Fi connections after a fresh boot on the Raspberry Pi.
